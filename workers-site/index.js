    ...
    ".svelte-kit/output/server/chunks/SvelteMarkdown-b91e19e3.js"() {
      ...
      Parser$1 = create_ssr_component(
        ($$result, $$props, $$bindings, slots) => {
          ...
          if (
            $$props.ordered === void 0 &&
            $$bindings.ordered &&
            ordered !== void 0
          )
            $$bindings.ordered(ordered);
          if (
            $$props.renderers === void 0 &&
            $$bindings.renderers &&
            renderers !== void 0
          )
        ...
        ${validate_component(
          renderers.tablebody || missing_component,
          "svelte:component",
        ).$$render(
          $$result,
          {},
      ...
      Paragraph = create_ssr_component(
        ($$result, $$props, $$bindings, slots) => {
      ...
      Blockquote = create_ssr_component(
        ($$result, $$props, $$bindings, slots) => {
          return `<blockquote>${
            slots.default ? slots.default({}) : ``
          }</blockquote>`;
      ...
      Code = create_ssr_component(($$result, $$props, $$bindings, slots) => {
        ...
        if ($$props.text === void 0 && $$bindings.text && text !== void 0)
          $$bindings.text(text);
        return `<pre${add_attribute("class", lang, 0)}><code>${escape(
          text,
        )}</code></pre>`;
      });
      ...
      SvelteMarkdown = create_ssr_component(
        ($$result, $$props, $$bindings, slots) => {
          let slugger;
          let combinedOptions;
...
`;
  ...
  function escape_html_attr(str) {
    return (
      '"' + escape$12(str, escape_html_attr_dict, code => `&#${code};`) + '"'
    );
  }
...
${``}`;
      ...
      get_hooks = hooks => ({
        ...
        handle:
          hooks.handle ||
          (({ request, resolve: resolve2 }) => resolve2(request)),
        handleError:
          hooks.handleError ||
  ...
  var require_dist = __commonJS({
    ".svelte-kit/cloudflare-workers/node_modules/@cloudflare/kv-asset-handler/dist/index.js"(
      ...
      var getAssetFromKVDefaultOptions = {
        ASSET_NAMESPACE:
          typeof __STATIC_CONTENT !== "undefined" ? __STATIC_CONTENT : void 0,
        ASSET_MANIFEST:
      ...
      function serveSinglePageApp(request, options2) {
        ...
        if (parsedUrl.pathname.endsWith(".html")) {
          return new Request(
            `${parsedUrl.origin}/${options2.defaultDocument}`,
            request,
          );
        } else {
          return request;
      ...
      var getAssetFromKV2 = (event, options2) =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          if (options2.mapRequestToAsset) {
            ...
            const mappedRawPathKey = new URL(
              mappedRequest.url,
            ).pathname.replace(/^\/+/, "");
          ...
          options2.cacheControl = Object.assign(
            {},
            defaultCacheControl,
            evalCacheOpts,
          );
          ...
          const shouldSetBrowserCache =
            typeof options2.cacheControl.browserTTL === "number";
          let response = null;
          if (shouldEdgeCache) {
          ...
          if (response) {
            if (response.status > 300 && response.status < 400) {
              if (
                response.body &&
                "cancel" in Object.getPrototypeOf(response.body)
              ) {
            ...
            if (shouldEdgeCache) {
              ...
              response.headers.set(
                "Cache-Control",
                `max-age=${options2.cacheControl.edgeTTL}`,
              );
