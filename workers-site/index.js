...
<div><h1 class="${"title"}">${escape(title)}</h1>
	...
	<div class="${"content"}">
		${validate_component(SvelteMarkdown, "SvelteMarkdown").$$render($$result, { source: articleBody }, {}, {})}</div></div>`;
      });
...
${``}`;
      ...
      module_lookup = {
        ".svelte-kit/build/components/layout.svelte": () => Promise.resolve().then(() => (init_layout_84a7d8b4(), layout_84a7d8b4_exports)),
        ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_85466862(), error_85466862_exports)),
        "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_c0b20ccf(), index_c0b20ccf_exports))
      };
      metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-9b276872.js", "css": [], "js": ["layout.svelte-9b276872.js", "chunks/vendor-ee965c0a.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-409a1b85.js", "css": [], "js": ["error.svelte-409a1b85.js", "chunks/vendor-ee965c0a.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-36d588d1.js", "css": [], "js": ["pages/index.svelte-36d588d1.js", "chunks/vendor-ee965c0a.js"], "styles": [] } };
    }
  });
