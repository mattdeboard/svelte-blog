import{S as v,i as x,s as I,N as S,e as m,t as g,k as R,j,c as p,a as _,g as w,d as c,n as q,m as $,b,f as D,D as i,o as M,E as N,x as T,u as E,v as P}from"../../../../chunks/vendor-40f27b4e.js";import{C as A}from"../../../../chunks/CodeRenderer-8c0a1f9a.js";function H(l){let e,a,d,h,u,s,o,n;return o=new S({props:{source:l[0],renderers:{code:A}}}),{c(){e=m("div"),a=m("p"),d=g("written on "),h=g(k),u=R(),s=m("div"),j(o.$$.fragment),this.h()},l(t){e=p(t,"DIV",{});var r=_(e);a=p(r,"P",{class:!0});var f=_(a);d=w(f,"written on "),h=w(f,k),f.forEach(c),u=q(r),s=p(r,"DIV",{class:!0});var y=_(s);$(o.$$.fragment,y),y.forEach(c),r.forEach(c),this.h()},h(){b(a,"class","date"),b(s,"class","content")},m(t,r){D(t,e,r),i(e,a),i(a,d),i(a,h),i(e,u),i(e,s),M(o,s,null),n=!0},p:N,i(t){n||(T(o.$$.fragment,t),n=!0)},o(t){E(o.$$.fragment,t),n=!1},d(t){t&&c(e),P(o)}}}let k="2012/02/07";function O(l){return[`
...
`]}class L extends v{constructor(e){super();x(this,e,O,H,I,{})}}export{L as default};
