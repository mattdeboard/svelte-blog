import{S as I,i as x,s as _,N as S,e as g,t as f,k as $,j as M,c as p,a as b,g as w,d as l,n as C,m as T,b as v,f as B,D as n,o as F,E as P,x as H,u as j,v as R}from"../../../../chunks/vendor-40f27b4e.js";import{C as A}from"../../../../chunks/CodeRenderer-8c0a1f9a.js";function q(h){let e,o,d,m,c,i,a,s;return a=new S({props:{source:h[0],renderers:{code:A}}}),{c(){e=g("div"),o=g("p"),d=f("written on "),m=f(k),c=$(),i=g("div"),M(a.$$.fragment),this.h()},l(t){e=p(t,"DIV",{});var r=b(e);o=p(r,"P",{class:!0});var u=b(o);d=w(u,"written on "),m=w(u,k),u.forEach(l),c=C(r),i=p(r,"DIV",{class:!0});var y=b(i);T(a.$$.fragment,y),y.forEach(l),r.forEach(l),this.h()},h(){v(o,"class","date"),v(i,"class","content")},m(t,r){B(t,e,r),n(e,o),n(o,d),n(o,m),n(e,c),n(e,i),F(a,i,null),s=!0},p:P,i(t){s||(H(a.$$.fragment,t),s=!0)},o(t){j(a.$$.fragment,t),s=!1},d(t){t&&l(e),R(a)}}}let k="2011/05/09";function D(h){return[`
...
`]}class U extends I{constructor(e){super();x(this,e,D,q,_,{})}}export{U as default};
