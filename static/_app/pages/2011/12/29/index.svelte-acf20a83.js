import{S,i as j,s as x,N as I,e as p,t as y,k as _,j as T,c as f,a as b,g as w,d as l,n as q,m as z,b as v,f as D,D as r,o as H,E,x as A,u as M,v as P}from"../../../../chunks/vendor-40f27b4e.js";import{C as $}from"../../../../chunks/CodeRenderer-8c0a1f9a.js";function L(c){let e,a,h,d,u,s,o,n;return o=new I({props:{source:c[0],renderers:{code:$}}}),{c(){e=p("div"),a=p("p"),h=y("written on "),d=y(k),u=_(),s=p("div"),T(o.$$.fragment),this.h()},l(t){e=f(t,"DIV",{});var i=b(e);a=f(i,"P",{class:!0});var m=b(a);h=w(m,"written on "),d=w(m,k),m.forEach(l),u=q(i),s=f(i,"DIV",{class:!0});var g=b(s);z(o.$$.fragment,g),g.forEach(l),i.forEach(l),this.h()},h(){v(a,"class","date"),v(s,"class","content")},m(t,i){D(t,e,i),r(e,a),r(a,h),r(a,d),r(e,u),r(e,s),H(o,s,null),n=!0},p:E,i(t){n||(A(o.$$.fragment,t),n=!0)},o(t){M(o.$$.fragment,t),n=!1},d(t){t&&l(e),P(o)}}}let k="2011/12/29";function C(c){return[`
...
`]}class O extends S{constructor(e){super();j(this,e,C,L,x,{})}}export{O as default};
